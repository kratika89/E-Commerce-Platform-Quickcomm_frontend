import { userstyleoffers } from "./Bankofferscss";
...
export default function Bankoffers(){
    ...
    const handleSumbit=async()=>{
        ...
        var result=await postData('bankoffers/bankoffer_sumbit',formData)
        if(result.status){
            Swal.fire({
                icon: "success",
