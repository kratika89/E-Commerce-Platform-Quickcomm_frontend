import { userstyleaddoffer } from "./Addofferscss";
import { FormControl, Grid,MenuItem,InputLabel,FormHelperText,Select,Button,Avatar, TextField } from "@mui/material";
...
const[categoryid,setcategoryid]=useState('')
    ...
    const handleSumbit=async()=>{
        ...
        var result=await postData('addoffer/addoffers_sumbit',formData)
        if(result.status){
            Swal.fire({
                icon: "success",
